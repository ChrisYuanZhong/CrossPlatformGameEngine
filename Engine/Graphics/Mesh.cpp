...
eae6320::cResult eae6320::Graphics::Mesh::LoadFromFile(Mesh*& o_mesh, const char* const meshPath)
{
	...
	{
		const auto luaResult = luaL_loadfile(luaState, meshPath);
		if (luaResult != LUA_OK)
		{
...
eae6320::cResult eae6320::Graphics::Mesh::LoadTableValues_vertices(lua_State& io_luaState, VertexFormats::sVertex_mesh*& i_vertexData, unsigned int& i_vertexCount)
{
...
eae6320::cResult eae6320::Graphics::Mesh::LoadTableValues_vertices_vertex(lua_State& io_luaState, VertexFormats::sVertex_mesh*& i_vertexData, unsigned int& i_vertexCount)
{
	...
	vertexData = new VertexFormats::sVertex_mesh[i_vertexCount];
...
eae6320::cResult eae6320::Graphics::Mesh::LoadTableValues_vertices_vertex_coordinates(lua_State& io_luaState, VertexFormats::sVertex_mesh& i_vertexData)
{
	auto result = eae6320::Results::Success;
...
eae6320::cResult eae6320::Graphics::Mesh::LoadTableValues_indices(lua_State& io_luaState, uint16_t*& i_indexData, unsigned int& i_indexCount)
{
	auto result = eae6320::Results::Success;
...
eae6320::cResult eae6320::Graphics::Mesh::LoadTableValues_indices_index(lua_State& io_luaState, uint16_t*& i_indexData, unsigned int& i_indexCount)
{
	// Right now the asset table is at -2
