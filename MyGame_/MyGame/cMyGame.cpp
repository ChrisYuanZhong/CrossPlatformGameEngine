...
void eae6320::cMyGame::UpdateSimulationBasedOnInput()
{
	...
	{
		gameObjectsToBeRendered[0].SetVelocity(gameObjectsToBeRendered[0].GetRigidBody().GetVelocity() + Math::sVector(0.0f, velocity, 0.0f));
	}
	if (gameInputs.isADown)
	{
		gameObjectsToBeRendered[0].SetVelocity(gameObjectsToBeRendered[0].GetRigidBody().GetVelocity() + Math::sVector(-velocity, 0.0f, 0.0f));
	}
