...
#ifndef EAE6320_SIDESCROLLINGPLATFORMER_H
#define EAE6320_SIDESCROLLINGPLATFORMER_H
...
namespace eae6320
{
	class SideScrollingPlatformer final : public Application::iApplication
	{
	...
	private:
		...
		{
			return "Chris Yuan Zhong's Side-Scrolling Platformer Game"
				" -- "
		...
		const char* GetMainWindowClassName() const final { return "Chris Yuan Zhong's Side-Scrolling Platformer Main Window Class"; }
		...
		std::vector<eae6320::Assets::GameObject*> gameObjectsToBeRendered;
		eae6320::Assets::GameObject* player;
		eae6320::Assets::Camera* mainCamera;
		eae6320::AudioSystem::cAudio backgroundMusic;
	};
}
